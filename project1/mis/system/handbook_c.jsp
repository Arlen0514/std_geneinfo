				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="system_table-2-1">
								<td rowspan="2" align="right" class="system_table-2-1">檔案</td>	
							...
							<tr class="system_table-2-1">
								<td colspan="3" align="left" class="tablebg">
									...
									<input name="fd_file" id="fd_file" type="file" class="button" onclick="frm.imgradio1[1].checked=true;"> 
								</td>
		                    </tr>
							...
							<tr class="system_table-2-1">
								...
								<td colspan="3" align="left">
									<textarea name="fd_content" id="fd_content" cols="100" rows="8"><%=fd.getString("fd_content")%></textarea>
								</td>
							</tr>
