				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						...
						for (int i = 0; i < fds.size(); i++) {
							...
							if("A".equals(fd.getString("fd_target"))) {
								ebookPage = "works_ebook_a.jsp";
							} else if("B".equals(fd.getString("fd_target"))) {
								ebookPage = "works_ebook_b.jsp";
							}
						%>
						...
						<tr class="web_table-2-1">
							...
							<td align="center">
								...
								<input type="button" value="預覽" onclick="window.open('../../web/ebook/<%=ebookPage %>?fd_id=<%=fd.getString("fd_id") %>', '_blank');" />&nbsp;
