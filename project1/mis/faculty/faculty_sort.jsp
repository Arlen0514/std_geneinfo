...
/*------------------------------------------------------------------------------------*/
	...
	fps = app_sm.selectAll(tblfp, "fp_code=? and fp_lang=? and fp_category=?", new Object[] { code,lang,qcategory }, "fp_showseq ASC , fp_createdate DESC");
						...
						<table width="100%" border="0" align="center" cellpadding="3"
							...
							<tr class="web_table-2-1">
								<td class="web_table-2-1" align="left"><select
									...
									%>
									<option value="<%=fp.getString("fp_id")%>"><%=fp.getString("fp_title")%></option>
									<%
										}
									%>
								</select></td>
