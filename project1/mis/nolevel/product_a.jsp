...
<%
	...
	int category_num = 0;		    		// 設定商品類別層數 2層以上使用選擇器 一層使用下拉選單即可
							...
							<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">			
								...
								<tr class="web_table-2-1">
									...
									<td align="left" class="tablebg">
										<input type="text" name="pd_emitdate" id="_qemitdate" value="<%=DateTimeTool.dateString()%>" size="15" readonly />
									</td>
									<td align="right" class="tablebg">下架日期</td>
									<td align="left" class="tablebg">
										<input type="text" name="pd_restdate" id="_qrestdate" value="2099/12/31" size="15" readonly />
									</td>
								</tr>
								<%} %>
