...
function checkform(F) {
	...
	if (F.mp_name.value == "") {
        ...
        alert("密碼欄位請輸入正確的英文或數字!!");
        F.mp_password.focus();
    } else if (F.mp_pswd.value == "" || !pwd.test(F.mp_pswd.value)) {
        alert("再次輸入密碼欄位請輸入正確的英文或數字!!");
        F.mp_pswd.focus();
            		...
            		<td colspan="2"><table width="95%"  border="0" cellspacing="1" cellpadding="0">
              			<tr>
                			<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
                    			...
                    			<tr align="center">
                      				<td class="web_table-2-1" align="right"><span class="style1">＊</span>會員姓名</td>
                      				<td class="web_table-2-1" align="left">
                        				<input name="mp_name" type="text" size="30" maxlength="15">
                      				</td>
                   	  				<td class="web_table-2-1" align="right"><span class="style1">＊</span>會員帳號(E-Mail)</td>
                      				<td class="web_table-2-1" align="left">
                    			...
                    			<tr align="center">
                      				...
                      				<td class="web_table-2-1" align="left">
                        				<input name="mp_cellphone" type="text" size="30">
                      				</td>
                    			</tr>
