...
/*---------------------------------------------------------------------------------------*/
	...
	if (search_switch) {
		...
		sb.append("ap_lang=? and ap_code=? and ap_category like ? and ap_title like ?");
		keys.add(lang);
		keys.add(code);
		keys.add("%" + qcategory + "%");
		keys.add("%" + qtitle + "%");		
	...
	//所屬類別
	Vector<TableRecord> dms = app_sm.selectAll(tbldm, "dm_category=? and dm_lang=? and dm_code=?", new Object[]{ "", lang, code+"_category" } , "dm_showseq ASC , dm_createdate DESC");
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						...
						<tr class="web_table-2-1">
							...
							<td width="35%" align="center">相簿名稱</td>	
						...
						<tr class="web_table-2-1">
							...
							<td align="center"><%=app_sm.select(tbldm,ap.getString("ap_category")).getString("dm_title") %></td>
