...
<%-- 20250331 modify Miles top menu.jsp  改成 RWD --%>
			...
			<tr>
				<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=M&ap_id=<%=ap_id %>&_qtitle=<%=qtitle %>&_qcategory=<%=qcategory %>&npage=<%=pageno %>" onsubmit="javascript:return checkform(this);">
