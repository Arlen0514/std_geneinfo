...
<%
	//基本參數
	String code = "product_category_img"; 		// 模組識別碼
	String show_title = "商品類別維護";			// 模組標題

	// 圖片建議尺寸
	String image_info = "(建議尺寸350px * 140px)";
	// 圖片建議尺寸
...
/*------------------------------------------------------------------------------------*/	
	Vector dms = app_sm.selectAll(tbldm, "dm_code=? and dm_lang=? and dm_category=?", new Object[] { code, lang, "" }, "dm_showseq ASC , dm_createdate DESC");
