...
/*------------------------------------------------------------------------------------*/	
	Vector dms = app_sm.selectAll(tbldm, "dm_code=? and dm_lang=? and dm_category=?", new Object[] { category_code, lang, upcategory }, "dm_showseq ASC , dm_createdate DESC");
	...
	// 回列表頁
	out.write(HtmlCoder.getForm("listpage", code + ".jsp?upcategory=" + upcategory, names, values));
...
<%-- 20250331 modify Miles top menu.jsp  改成 RWD --%>
			...
			<tr>
				<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=M&upcategory=<%=upcategory %>&dm_id=<%=dm_id %>&_qtitle=<%=qtitle %>&npage=<%=pageno %>" onsubmit="javascript:return checkform(this);">
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								<td rowspan="2" align="right" class="web_table-2-1">類別代表圖檔</td>	
								<td colspan="3" align="left" class="tablebg">&nbsp;
						        <% if(!dm.getString("dm_image").isEmpty()){ %>
									<img src="<%=app_fetchpath+"/"+category_code+"/"+lang+"/"+dm.getString("dm_image")%>" width="198">		                      		
							    <% } %>
								</td>
		                    </tr>
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<textarea name="dm_content" id="dm_content" cols="100" rows="8" class="mceEditor"><%=dm.getString("dm_content")%></textarea>
								</td>
							</tr>
							...
							<tr class="web_table-2-1">
								...
								<td align="left">
									<input type="text" name="dm_keywords" id="dm_keywords" size="40" maxlength="255" value="<%=dm.getString("dm_keywords") %>"/>
								</td>
								<td align="right">設定網頁版權說明</td>
								<td align="left">
									<input type="text" name="dm_copyright" id="dm_copyright" size="30" value="<%=dm.getString("dm_copyright") %>"/>
								</td>
							</tr>
							<tr class="web_table-2-1">
								<td align="right">
