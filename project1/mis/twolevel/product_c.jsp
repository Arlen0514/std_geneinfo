...
<%-- 20250331 modify Miles top menu.jsp  改成 RWD --%>
		<form name="form0" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=M&pd_id=<%=pd_id %>&_qtitle=<%=qtitle %>&npage=<%=pageno %>&_qcategory=<%=qcategory %>&_qupcategory=<%=qupcategory %>" onsubmit="javascript:return checkform(this);">
