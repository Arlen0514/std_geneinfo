...
/*-------------------------------------------------------------------------------*/
	...
	if (search_switch) {
		...
		sb.append("pd_lang=? and pd_code=? and pd_category like ? and pd_title like ?");
		keys.add(lang);
		keys.add(code);
		keys.add("%" + qcategory + "%");
		keys.add("%" + qtitle + "%");		
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						...
						<tr class="web_table-2-1">
							...
							<td align="center"><img src="<%=app_fetchpath+"/"+code+"/"+pd.getString("pd_lang")+"/"+pd.getString("pd_image") %>" width="200px"></td>
