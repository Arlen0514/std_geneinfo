					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" width="85%" align="left">
									...
									<span id="dm_title" style="color:#FA0300;"></span>
                   					<input type="hidden" name="sp_upcategory" id="sp_upcategory" />
									<input type="hidden" name="sp_category" id="sp_category" />
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" width="85%" align="left">
									<input type="text" name="sp_time" id="sp_time" size="100" maxlength="120" />
								</td>
							</tr>
							...
							<tr class="web_table-2-1">
								...
								<td align="left" class="tablebg">
									<input name="sp_emitdate" id="_qemitdate" type="text" value="<%=DateTimeTool.dateString()%>" size="15" readonly>
								</td>
								<td align="right" class="tablebg">下架日期</td>
								<td align="left" class="tablebg">
									<input name="sp_restdate" id="_qrestdate" type="text" value="2099/12/31" size="15" readonly>
								</td>
							</tr>
							<%} %>
							<tr class="web_table-2-1">
