					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" width="85%" align="left">
									...
									<span id="dm_title" style="color:#FA0300;"></span>
                   					<input type="hidden" name="fd_upcategory" id="fd_upcategory" />
									<input type="hidden" name="fd_category" id="fd_category" />
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<select name="fd_target" id="fd_target">
										<option value="U">外部連結</option>
										<option value="F">檔案</option>
										<option value="N">不開放下載</option>
									</select>
								</td>
							</tr>
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<input type="text" name="fd_url" id="fd_url" size="100" />
								</td>
							</tr>
