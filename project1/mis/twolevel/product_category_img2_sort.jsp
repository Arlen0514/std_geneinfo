				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3"
							...
							<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=S&upcategory=<%=upcategory %>" onsubmit="javascript:return checkformsequ(this);">
							<tr class="web_table-2-1">
								<td class="web_table-2-1" align="left"><select
									name="left_select" id="left_select" multiple="multiple"
									style="width: 1075px;" size="15">
									<%
