...
(function () {
    ...
    const unlinkImageFigure = (editor, fig) => {
      ...
      if (img) {
        ...
        if (a) {
          (_a = a.parentNode) === null || _a === void 0 ? void 0 : _a.setAttribute(img, a);	//20250221 Miles 
          editor.dom.remove(a);
        }
      }
    };
    ...
    const linkImageFigure = (dom, fig, attrs) => {
      ...
      if (img) {
        ...
        (_a = img.parentNode) === null || _a === void 0 ? void 0 : _a.setAttribute(a, img);//20250221 Miles 
        a.appendChild(img);
      }
    };
    */
	const linkImageFigure = (dom, fig, attrs) => {
	  ...
	  if (img && img instanceof HTMLImageElement) { 
	    img.removeAttribute("onerror"); // 移除可能的 XSS
	    ...
	    if (parent && parent instanceof HTMLElement) { 
	      parent.replaceChild(a, img); // 替換 img 為 <a>
	      a.innerHTML = ''; // 清空舊內容，避免 XSS
	      a.append(img); // 安全插入 img
	    }
	  }
	};    
