...
function initCounty(countyInput, defaultcity) {
  ...
  for (i = 0; i < County.length; i++) {
    if (i == 0) countyInput.options[i].value = "";
    else countyInput.options[i].value = County[i];
...
function changeZone(countyInput, zoneInput, post, defaultcity, defaulttown) {
  ...
  for (i = 0; i < Zone[selectedCountyIndex].length; i++) {
    if (i == 0) zoneInput.options[i].value = "";
    else zoneInput.options[i].value = Zone[selectedCountyIndex][i];
...
function updateaddress(countyInput, zoneInput, defaultcity, defaulttown) {
  defaultcity.value =
    countyInput.options[countyInput.selectedIndex].text +
