...
<%
	// 基本參數
	String code = "product_category"; 		// 模組識別碼
								...
								<tr class="web_table-2-1">
									...
									<td align="left">
										...
										<%if (delete_switch) { %>					
											<%
											// 確認是否有資料使用到該類別
											Vector<TableRecord> pds=app_sm.selectAll(tblpd,"pd_category=?",new Object[]{dm.getString("dm_id")});
											if(pds.size()>0){
											%>
											<input type="button" value="刪除" onclick="alert('此類別已建立相關資料，不可刪除');" />
											<% }else{ %>
