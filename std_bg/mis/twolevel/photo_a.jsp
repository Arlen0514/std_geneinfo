						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" width="85%" align="left">
									...
									<span id="dm_title" style="color:#FA0300;"></span>
                   					<input type="hidden" name="ap_upcategory" id="ap_upcategory" />
									<input type="hidden" name="ap_category" id="ap_category" />
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<textarea name="ap_desc" id="ap_desc" cols="100" rows="8" class="ezEditor"></textarea>
								</td>
							</tr>
