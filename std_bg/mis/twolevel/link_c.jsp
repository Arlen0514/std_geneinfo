...
<%
	//基本參數
	String code = "link"; 					// 模組識別碼
	String show_title = "外部連結維護";		// 模組標題
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" width="85%" align="left">
									...
									<input type="hidden" name="cp_category" id="cp_category"  value="<%=cp.getString("cp_category") %>"/>
                  					<input type="button" value="選擇類別" onclick="window.open('../mis_tools/category_selector.jsp?Back_id=cp_category&Back_category=cp_upcategory&max_layer=<%=category_num %>&dm_code=<%=code%>_category','_blank','height=260,width=400,top=50,left=300,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');" />
                  					<% } %>
                  					<%--
									//兩層下拉
									<select name="cp_category" id="cp_category">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<select name="cp_target" id="cp_target">
										<option value="none" <%=cp.getString("cp_target").equals("none")?"selected":""%>>不連結</option>
										<option value="_self" <%=cp.getString("cp_target").equals("_self")?"selected":""%>>目前頁面</option>
										<option value="_blank" <%=cp.getString("cp_target").equals("_blank")?"selected":""%>>開新頁面</option>
									</select>
								</td>
							</tr>
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left" class="tablebg">&nbsp;							 
									<img src="<%=app_fetchpath+"/"+code+"/"+lang+"/"+cp.getString("cp_image") %>" width="187" />		                      		
								</td>
		                    </tr>
