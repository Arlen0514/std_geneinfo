...
/*--------------------------------------------------------------------------------------------*/
	...
	if (search_switch) {
		...
		sb.append("dm_lang=? and dm_code=? and dm_title like ? and dm_category=?");
		keys.add(lang);
		keys.add(category_code);
		keys.add("%" + qtitle + "%");
		keys.add(upcategory);
	...
	// 分頁
	out.write(HtmlCoder.getForm("pageform", request.getRequestURI() + "?upcategory=" + upcategory, names, values));
						...
						<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							<tr>
								...
								<td align="center" class="web_title-1">
									<input type="button" value="回上一層" onclick="javascript:location.href='<%=category_code%>.jsp'" />
								</td>
							</tr>
...
<form name="list_sea" id="list_sea" method="post" action="<%=code %>.jsp?upcategory=<%=upcategory %>" onsubmit="return checkform(this);">
							<tr class="web_table-2-1">
								<td align="center"><input name="_qtitle" id="_qtitle" type="text" value="<%=qtitle %>" size="150" /></td>							
		                    	<td align="center">
					...
					<td align="center" colspan="2"><table width="95%" border="0" cellspacing="1" cellpadding="0">
						<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td width="20%" align="center">類別代表圖</td>				
								<td width="55%" align="center">類別名稱</td>
								<td width="20%" align="center">功能</td>
							</tr>
...
<form name="list<%=i + 1%>" id="list<%=i + 1%>" method="post">
							<tr class="web_table-2-1">
								...
								<td align="center"><img src="<%=app_fetchpath+"/"+category_code+"/"+lang+"/"+dm.getString("dm_image")%>" width="79"></td>												
								...
								<td align="center">
									...
									<input type="hidden" name="upcategory" id="upcategory" value="<%=upcategory %>" />
									<%if (modify_switch) { %> 
