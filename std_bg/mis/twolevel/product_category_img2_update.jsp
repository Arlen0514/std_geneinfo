...
try{
	...
	//檔案路徑與設置
	String dir = application.getRealPath("/") + "uploads/"+category_code+"/"+lang+"/";
	...
	if("S".equals(action)){
		...
		app_sm.close();
		// 回排序頁
		out.write(HtmlCoder.getForm("sortpage", code + "_sort.jsp?upcategory=" + upcategory, names, values));
	...
	if("A".equals(action)){		
		...
		dm.setValue("dm_category", upcategory);		// 上層類別
		dm.setValue("dm_code", category_code);		// 識別碼
