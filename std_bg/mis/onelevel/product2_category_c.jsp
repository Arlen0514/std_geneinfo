...
<%
	//基本參數
	String code = "product2_category"; 		// 模組識別碼
	String show_title = "產品類別維護";		// 模組標題

	// 圖片建議尺寸
	String image_info = "(建議尺寸500px * 400px)";
	// 圖片建議尺寸
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								<td width="15%" align="right">產品類別名稱</td>
							...
							<tr class="web_table-2-1">
								<td rowspan="2" align="right" class="web_table-2-1">產品類別代表圖檔</td>	
