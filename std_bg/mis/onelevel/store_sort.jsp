...
/*------------------------------------------------------------------------------------*/
	...
	sps = app_sm.selectAll(tblsp, "sp_code=? and sp_lang=? and sp_category=?", new Object[] { code,lang,qcategory }, "sp_showseq ASC , sp_createdate DESC");
						...
						<table width="100%" border="0" align="center" cellpadding="3"
							...
							<tr class="web_table-2-1">
								<td class="web_table-2-1" align="left"><select
									...
									%>
									<option value="<%=sp.getString("sp_id")%>"><%=sp.getString("sp_title")%></option>
									<%
										}
									%>
								</select></td>
