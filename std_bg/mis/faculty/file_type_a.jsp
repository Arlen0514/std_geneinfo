...
function checkform(F){
	...
	//驗證中文
	var chnese_chk = /[\u4e00-\u9fa5]/;
	//var image = document.getElementById('dm_image').files[0];
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								<td width="15%" align="right">類型名稱</td>
							...
							<tr class="web_table-2-1">
								...
								<td align="left" class="tablebg">
									<input type="text" name="dm_emitdate" id="_qemitdate" value="<%=DateTimeTool.dateString()%>" size="15" readonly />
								</td>
								<td align="right" class="tablebg">下架日期</td>
								<td align="left" class="tablebg">
									<input type="text" name="dm_restdate" id="_qrestdate" value="2099/12/31" size="15" readonly />
								</td>
							</tr>
							<%} %>
