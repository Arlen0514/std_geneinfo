...
<%
	...
	// 基本參數
	String code = "education"; 		// 模組識別碼
	TableRecord fp = app_sm.select(tblfp,fp_id);  // 所屬類別資料
	String show_title = fp.getString("fp_title")+"-學歷";			// 模組標題
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3"
							...
							<tr align="center">
								...
								<td colspan="3" class="web_title-1">
									<%-- 
									<%if (add_switch) { %>
									...
									--%>
									<%if (list_switch) { %>
									<input type="button" value="回到學歷列表" onclick="listpage.submit();" />&nbsp;
									<%} %>
									<%if (sort_switch) { %>
									<input type="button" value="學歷排序" onclick="sortpage.submit();" />
									<%} %>
								</td>
								<td class="web_title-1">
							...
							<tr align="center" class="web_bk-2">
								<td colspan="5" align="center" class="tablebg"><%= show_title%>列表</td>
							</tr>
							<tr align="center" class="web_table-2-1">
								<td width="10%" align="center">編號</td>
								<td width="10%" align="center">年度</td>
								<td width="30%" align="center">學校名稱</td>
								<td width="30%" align="center">學位</td>
							...
							<tr class="web_table-2-1">
								...
								<td align="left">
								<div align="center">
									<input name="fr_school" type="text" value="" size="40" maxlength="120"/>
								</div>
								</td>
								
								<td align="left">
								<div align="center">
									<input name="fr_degree" type="text" value="" size="30" maxlength="120"/>
								</div>
								</td>
							...
							<form name="form<%=i + 1%>" method="post" enctype="multipart/form-data">
								<tr class="web_table-2-1">
									...
									<td align="left">
										<div align="center">
											<input name="fr_school" type="text" value="<%=fr.getString("fr_school")%>" size="40" maxlength="120"/>
										</div>
									</td>
									
									<td align="left">
										<div align="center">
											<input name="fr_degree" type="text" value="<%=fr.getString("fr_degree")%>" size="30" maxlength="120"/>
										</div>
									</td>
