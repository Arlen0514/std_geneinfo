...
<%
	// 基本參數
	String code = "faculty_category"; 		// 模組識別碼
	String show_title = "師資類別維護";			// 模組標題
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3"
							...
							<tr class="web_table-2-1">
								...
								<td align="left">
								<div align="center">
									<input name="dm_title" type="text" value="" size="80" maxlength="120"/>
							...
							<form name="form<%=i + 1%>" method="post">
								<tr class="web_table-2-1">
									...
									<td align="left">
										<div align="center">
											<input name="dm_title" type="text" value="<%=dm.getString("dm_title")%>" size="80" maxlength="120"/>
											<input name="dm_category" type="hidden" value="<%=qcategory%>"/>
										</div>
									</td>
									<td align="left">
										...
										<%if (delete_switch) { %>
											<%
											// 確認是否有資料使用到該類別
											Vector<TableRecord> fps=app_sm.selectAll(tblfp,"fp_category=?",new Object[]{dm.getString("dm_id")});
											if(fps.size()>0){
											%>
											<input name="modify<%=i + 1%>" type="button" value="刪除" onClick="alert('此類別已建立相關資料，不可刪除');">
											<% }else{ %>
