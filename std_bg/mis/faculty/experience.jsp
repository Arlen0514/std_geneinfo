...
<%
	...
	// 基本參數
	String code = "experience"; 		// 模組識別碼
	TableRecord fp = app_sm.select(tblfp,fp_id);  // 所屬類別資料
	String show_title = fp.getString("fp_title")+"-經歷";			// 模組標題
						...
						<table width="100%" border="0" align="center" cellpadding="3"
							...
							<tr align="center">
								...
								<td colspan="4" class="web_title-1">
									...
									--%>
									<%if (list_switch) { %>
									<input type="button" value="回到經歷列表" onclick="listpage.submit();" />&nbsp;
									<%} %>
									<%if (sort_switch) { %>
									<input type="button" value="經歷排序" onclick="sortpage.submit();" />
									<%} %>
								</td>
								<td class="web_title-1">
							...
							<tr align="center" class="web_table-2-1">
								...
								<td width="30%" align="center">服務機關名稱</td>
								<td width="20%" align="center">單位</td>
								<td width="20%" align="center">職稱</td>
							...
							<tr class="web_table-2-1">
								...
								<td align="left">
								<div align="center">
									<input name="fr_year" type="text" value="" size="5" maxlength="120"/>
								...
								<td align="left">
								<div align="center">
									<input name="fr_school" type="text" value="" size="20" maxlength="120"/>
								</div>
								</td>
								
								<td align="left">
								<div align="center">
									<input name="fr_department" type="text" value="" size="20" maxlength="120"/>
								</div>
								</td>
								
								<td align="left">
								<div align="center">
									<input name="fr_job" type="text" value="" size="20" maxlength="120"/>
								</div>
								</td>
							...
							<form name="form<%=i + 1%>" method="post" enctype="multipart/form-data">
								<tr class="web_table-2-1">
									...
									<td align="left">
										<div align="center">
											<input name="fr_school" type="text" value="<%=fr.getString("fr_school")%>" size="30" maxlength="120"/>
										</div>
									</td>
									...
									<td align="left">
										<div align="center">
											<input name="fr_job" type="text" size="30" maxlength="120" value="<%=fr.getString("fr_job")%>" />
										</div>
									</td>
