											...
											<td class="system_bk-2bk">
												<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
													...
													<tr class="web_table-2-1">
														<td width="15%" align="right">圖片壓縮大小</td>
														<td colspan="3" width="85%" align="left">
															寬度:&nbsp;<input type="number" name="_width" size="15" value="800" min="1" required/>
															&nbsp;&nbsp;&nbsp;&nbsp;
															高度:&nbsp;<input type="number" name="_hight" size="15" value="600" min="1" required/>
														</td>
													</tr>
													...
													<tr class="web_table-2-1">
														...
														%>					 
															<img src="<%=app_fetchpath+"/"+upload_code+"/"+lang+"/"+imageTok[l] %>" width="100%">
															<br /><br />
														<%
															}
														}
								                    ...
								                    <tr class="web_table-2-1">
														<td colspan="3" align="left" class="tablebg">
															...
															<input name="cp_image" id="cp_image" type="file" class="button" accept="image/*" onclick="frm.imgradio[1].checked=true;" multiple="multiple"> <%--=image_info--%>
														</td>
								                    </tr>
								                    
								                    <tr class="web_table-2-1">
														<td width="15%" align="right">壓縮圖檔下載</td>
														<td colspan="3" width="85%" align="left">
														<%
														if(!"".equals(cp.getString("cp_image"))) {
															for(int l = 0; l < imageTok.length; l++) {
