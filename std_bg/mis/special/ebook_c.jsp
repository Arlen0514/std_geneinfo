						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" width="85%" align="left">
									<input type="text" name="fd_title" id="fd_title" value="<%=fd.getString("fd_title")%>" size="100" maxlength="120" />
								</td>
							</tr>
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<select name="fd_target" id="fd_target">
										...
										<option value="A" <%=fd.getString("fd_target").equals("A")?"selected":""%>>A4大小</option>
										<option value="B" <%=fd.getString("fd_target").equals("B")?"selected":""%>>非A4大小</option>
									</select>
								</td>
							</tr>
							
							<tr class="web_table-2-1">
								<td rowspan="2" align="right" class="web_table-2-1">PDF檔案</td>	
							...
							<tr class="web_table-2-1">
								<td colspan="3" align="left" class="tablebg">
									<input type="radio" name="imgradio1" value="ucpic" checked onclick="frm.fd_file.value='';" />使用原檔<br />
									<input type="radio" name="imgradio1" value="new" />上傳新檔
									<input type="file" name="fd_file" id="fd_file" class="button" accept=".pdf" onclick="frm.imgradio1[1].checked=true;" /> 
								</td>
		                    </tr>
