...
<%
	// 基本參數
	String code = "handbook"; 				// 模組識別碼
	String show_title = "使用者手冊維護";		// 模組標題
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="system_table-2-1">
								<td align="right" class="system_table-2-1">檔案</td>
							...
							<tr class="system_table-2-1">
								...
								<td colspan="3" align="left">
									<textarea name="fd_content" id="fd_content" cols="100" rows="8"></textarea>
								</td>
							</tr>
							...
							<tr class="system_table-2-1">
								...
								<td colspan="3" align="left">
									<input type="text" name="fd_webtitle" id="fd_webtitle" size="100" maxlength="255" value="<%=SiteSetup.getSetup("system_title"+"."+lang).getString("ss_text") %>"/>
								</td>
							</tr>
