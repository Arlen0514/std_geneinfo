...
<form name="frm" id="frm" method="post"  action="<%=code%>_update.jsp?action=S" onsubmit="javascript:return checkformsequ(this);">
								<tr class="web_table-2-1">
									<td class="web_table-2-1" align="left">
										<select name="left_select" id="left_select" multiple="multiple" style="width: 660px;" size="15">
											...
											%>
											<option value="<%=pd.getString("pd_id")%>"><%=pd.getString("pd_title")%></option>
											<%} %>
										</select>
									</td>
