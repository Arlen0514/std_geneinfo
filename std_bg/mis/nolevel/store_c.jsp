...
<script>
	function checkform(F) {
		...
		if (F.sp_area.value == "") {
	        ...
	        alert("請輸入正確的email!!");
	        F.sp_email.focus();
	    } else if (F.sp_image.value != "" && !file_chk.test(F.sp_image.value.toLowerCase())) {
...
<%-- 20250331 modify Miles top menu.jsp  改成 RWD --%>
				...
				<tr>
<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=M&sp_id=<%=sp_id %>&_qtitle=<%=qtitle %>&npage=<%=pageno %>" onsubmit="javascript:return checkform(this);">
						...
						<tr>
							<td class="system_bk-2bk"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
								...
								<tr class="web_table-2-1">
									...
									<td colspan="3" width="85%" align="left">
										<input type="text" name="sp_email" id="sp_email" size="100" maxlength="120"  value="<%=sp.getString("sp_email")%>"/>
									</td>
								</tr>
								...
								<tr class="web_table-2-1">
									...
									<td colspan="3" align="left" class="tablebg">&nbsp;							 
										<img src="<%=app_fetchpath+"/"+code+"/"+lang+"/"+sp.getString("sp_image")%>" width="187">		                      		
									</td>
			                    </tr>
			                    
			                    <tr class="web_table-2-1">
									<td colspan="3" align="left" class="tablebg">
										<input name="imgradio" type="radio" value="ucpic" checked onclick="frm.sp_image.value='';">使用原圖<br>
										<input name="imgradio" type="radio" value="new">上傳新圖
										<input name="sp_image" id="sp_image" type="file" class="button" accept="image/*" onclick="frm.imgradio[1].checked=true;"> <%=image_info%>
									</td>
			                    </tr>	
								...
								<tr class="web_table-2-1">
									...
									<td align="left" class="tablebg">
										<input type="text" name="sp_emitdate" id="_qemitdate" value="<%=sp.getString("sp_emitdate") %>" size="15" readonly />
									</td>
									<td align="right" class="tablebg">下架日期</td>
									<td align="left" class="tablebg">
										<input type="text" name="sp_restdate" id="_qrestdate" value="<%=sp.getString("sp_restdate") %>" size="15" readonly />
									</td>
								</tr>
								<%} %>
