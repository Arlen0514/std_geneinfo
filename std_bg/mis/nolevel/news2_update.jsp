...
try{
	...
	if("D".equals(action)) {
		...
		if (app_sm.success()) {
			...
			out.println("<script> alert('刪除失敗，失敗原因："+app_sm.getMessage()+"'); history.back(); </script>");
		}	
		return;
	}
	...
	if("S".equals(action)) {
		...
		if(app_sm.success()) {
			...
			out.println("<script> alert('排序失敗，失敗原因："+app_sm.getMessage()+"'); history.back(); </script>");
		}
		return;
	}
	...
	if("A".equals(action)) {		
		...
		if(app_sm.success()) {
			...
			out.println("<script> alert('新增失敗，失敗原因："+app_sm.getMessage()+"'); history.back(); </script>");
		}
		return;
	...
	// 修改
		...
		if(app_sm.success()) {
			...
			out.println("<script> alert('修改失敗，失敗原因："+app_sm.getMessage()+"'); history.back(); </script>");
		}
		return;
	}
} catch(Exception e) {
