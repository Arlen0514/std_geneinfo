...
/*--------------------------------------------------------------------------------------------*/
	...
	if (search_switch) {
		...
		sb.append("sp_lang=? and sp_code=? and sp_title like ?");
		keys.add(lang);
		keys.add(code);
		keys.add("%" + qtitle + "%");			
...
<form name="list_sea" id="list_sea" method="post" action="<%=code %>.jsp" onsubmit="return checkform(this);">
							<tr class="web_table-2-1">
								<td align="center">
									<input name="_qtitle" id="_qtitle" type="text" value="<%=qtitle %>" size="80" />
								</td>							
		                    	<td align="center">
...
<form name="list<%=i + 1%>" id="list<%=i + 1%>" method="post">
							<tr class="web_table-2-1">
								...
								<td align="center">
									<%=sp.getString("sp_title") %>
								</td>	
								<td align="center">
									<img src="<%=app_fetchpath+"/"+code+"/"+lang+"/"+sp.getString("sp_image")%>" width="79" />
								</td>												
								<td align="center">
