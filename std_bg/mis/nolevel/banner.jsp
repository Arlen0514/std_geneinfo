...
<form name="list_sea" id="list_sea" method="post" action="<%=code %>.jsp" onsubmit="return checkform(this);">
							<tr class="web_table-2-1">
								<td align="center">
									<input type="text" name="_qtitle" id="_qtitle" value="<%=qtitle %>" size="50" />
								</td>
								<td align="center">
			                    	<input type="text" name="_qemitdate" id="_qemitdate" value="<%=qemitdate %>" size="10" readonly />
		                        		~
		                    		<input type="text" name="_qrestdate" id="_qrestdate" value="<%=qrestdate %>" size="10" readonly />
		                    	</td>
		                    	<td align="center">
